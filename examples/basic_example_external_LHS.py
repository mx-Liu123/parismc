...
def main():
    ...
    # Prepare initial LHS samples externally (same logic as internal)
    print("Preparing external LHS samples...")
    lhs_num = 1000
    batch_size = 100
    # Generate LHS points in the unit hypercube [0,1]^ndim
    xlimits = np.array([[0, 1]] * ndim, dtype=np.float32)
